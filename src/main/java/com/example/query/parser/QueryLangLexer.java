...
public class QueryLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "SELECT", "FROM", "WHERE", "AND", "CONTAINS", 
			"NER", "DATE", "DEPENDS", "ORDER", "BY", "ASC", "DESC", "LIMIT", "NEAR", 
			"WILDCARD", "STRING", "IDENTIFIER", "NUMBER", "WS", "COMMENT"
		};
	}
	...
	public QueryLangLexer(CharStream input) {
		super(input);
